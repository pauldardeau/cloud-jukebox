...
class PropertyValue(object):
    ...
    def get_int_value(self) -> int:
        if self.is_int():
            ...
            print("error: calling get_int_value, but data type is '%s'" % self.data_type)
            return 0
    ...
    def get_bool_value(self) -> bool:
        if self.is_bool():
            ...
            print("error: calling get_bool_value, but data type is '%s'" % self.data_type)
            return False
    ...
    def get_string_value(self) -> str:
        if self.is_string():
            ...
            print("error: calling get_string_value, but data type is '%s'" % self.data_type)
            return ""
